...
class MediaDevicesManager {
    ...
    loadStream(id, videoId, audioId, outputId, onload, constraints, screenshare) {
        ...
        const promise = screenshare ? navigator.mediaDevices.getDisplayMedia() : navigator.mediaDevices.getUserMedia(constraints);
        promise.then((stream) => {
